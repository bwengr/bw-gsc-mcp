...
server.setRequestHandler({ method: 'tools/call' }, async (request) => {
  ...
  try {
    ...
    if (name === 'getRankingChanges') {
      const period2Start = new Date();
      period2Start.setDate(period2Start.getDate() - args.days * 2);
      const period1Start = new Date(period2Start);
      period1Start.setDate(period1Start.getDate() - args.days);
